...
namespace Budapest
{
    ...
    public class TakeWhileWithConstantTruePredicate : DiagnosticAnalyzer
    {
        private const string Category = "Performance";
        public const string DiagnosticId = nameof(TakeWhileWithConstantTruePredicate);
        ...
        private static void AnalyzeWhereMethod(SyntaxNodeAnalysisContext context)
        {
            ...
            if (identifier.Identifier.ValueText != "TakeWhile")
                return;
