...
namespace Budapest
{
    ...
    public sealed class EmptyObjectInitializerExpression : DiagnosticAnalyzer
    {
        private const string Category = "Performance";
        public const string DiagnosticId = nameof(EmptyObjectInitializerExpression);
        ...
        {
            var syntax = context.Node as InitializerExpressionSyntax;
