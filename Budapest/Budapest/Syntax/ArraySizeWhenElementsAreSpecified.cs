...
namespace Budapest
{
    ...
    public sealed class ArraySizeWhenElementsAreSpecified : DiagnosticAnalyzer
    {
        ...
        private static void Analyze(SyntaxNodeAnalysisContext context)
        {
            ...
            // TODO: make it work with more complex arrays
            if (syntax.Initializer.Expressions.Any() &&
                syntax.Type.RankSpecifiers.Count == 1)
                context.MarkAsUnnecessary(Rule, syntax.Type.RankSpecifiers.Last().Sizes.First(), syntax.Type.RankSpecifiers.Last().Sizes.Last());
        }
    }
}
