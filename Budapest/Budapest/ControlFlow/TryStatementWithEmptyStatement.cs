...
namespace Budapest
{
    ...
    public sealed class EmptyTryBlock : DiagnosticAnalyzer
    {
        private const string Category = "Performance";
        public const string DiagnosticId = nameof(EmptyTryBlock);
        ...
        {
            var syntax = context.Node as TryStatementSyntax;
