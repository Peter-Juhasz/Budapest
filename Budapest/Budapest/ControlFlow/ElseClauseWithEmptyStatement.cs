...
namespace Budapest
{
    ...
    public sealed class ElseClauseWithEmptyStatement : DiagnosticAnalyzer
    {
        private const string Category = "Performance";
        public const string DiagnosticId = nameof(ElseClauseWithEmptyStatement);
        ...
        {
            var syntax = context.Node as ElseClauseSyntax;

            if (syntax.Statement.IsEmpty())
