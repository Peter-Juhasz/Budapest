...
namespace Budapest
{
    ...
    public sealed class EmptyFinallyBlock : DiagnosticAnalyzer
    {
        private const string Category = "Performance";
        public const string DiagnosticId = nameof(EmptyFinallyBlock);
        ...
        {
            var syntax = context.Node as FinallyClauseSyntax;

            if (!syntax.Block.Statements.Any())
            {
